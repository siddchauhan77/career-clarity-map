...
const CRAFT_SKILLS = [
  {
    ...
    color: "mint",
    icon: "★",
    desc: "The skills at the center of the map. They power everything else. What gets complimented unprompted. The literal WHY.",
    skills: [
      { name: "clarity",     label: "Translating Complexity → Clarity",   proof: "CliftonStrengths: 4/5 Strategic Thinking themes. Core identity: 'Strategic Sensemaker who turns complex systems (AI, data, product, UX) into clear decisions, systems, and content people can act on.' What friends literally say.", tools: [] },
      { name: "writing",     label: "Writing, Copy & Long-Form",           proof: "PGA Premium Ghostwriting Academy trained. Ship 30. 30%+ email opt-in rates. Proposals, email courses, strategy docs, launch copy, sales enablement. The Wedify brief = unsolicited PMM deliverable before having the title.", tools: [] },
      { name: "positioning", label: "Product Positioning & Messaging",     proof: "Prescene.ai PMM externship. TikTok Brand Playbook. Wedify brand brief. Core PMM function: who the product is for, why it matters, how it differs. Uses April Dunford framework. PMM proof before PMM title.", tools: [] },
      { name: "systems",     label: "Systems Architecture",                proof: "Notion Advanced Badge. Built 35+ apps and full operating systems. n8n/Make automation workflows at Wayfair that replaced manual research processes. SOPs, content pipelines, knowledge infrastructure.", tools: ["Notion", "n8n", "Make"] },
      { name: "frameworks",  label: "Framework Creation",                  proof: "Vetting Scorecard, Weekly OS, role targeting matrix, content repurposing system — I turn learning into reusable tools others can run. PMM role uses 16 of 27 CraftSkills simultaneously.", tools: [] },
      { name: "research",    label: "Deep Research & Synthesis",           proof: "UT Austin MSBA trained. Pull signal from noise across any domain fast. Built competitive intelligence dashboards at Wayfair. News Corp 7-platform competitive analysis + 15+ engagement features benchmarked.", tools: ["Power BI", "SQL"] },
      { name: "teaching",    label: "Teaching & Explaining",               proof: "90th percentile Coaching (High5). Educational writing, clarity-first explanation, onboarding content. 87th percentile Creative Production. Designed 6–8 email onboarding sequence at Prescene.ai.", tools: [] },
      { name: "taste",       label: "Curation & Taste",                    proof: "VIA Character Strength #1: Appreciation of Beauty & Excellence. Strong aesthetic eye across visual design, writing, and information architecture. NatGeo-featured photography is the proof.", tools: [] },
    ]
  },
  {
    cat: "Tier 2 — Domain Skills",
    color: "amber",
    icon: "↗",
    desc: "Hard skills with real proof across multiple externships and roles. Each one has reps behind it.",
    skills: [
      { name: "gtm",           label: "Go-to-Market Strategy",               proof: "TikTok brand playbook + 30-day content roadmap + 3 campaign-ready assets. News Corp PRD (12 features prioritized, 6 success metrics). Wayfair market intelligence platform. Mini-GTM work before having the title.", tools: [] },
      { name: "competitive",   label: "Competitive Analysis & Market Intel",  proof: "Accenture client-facing delivery + Wedify landscape analysis + Wayfair Comet dashboards + News Corp 7-platform comp analysis + 15+ feature benchmarks. Multi-context proof.", tools: ["Power BI", "Figma"] },
      { name: "video",         label: "Video Editing & Production",           proof: "DaVinci Resolve, filming, shooting. Genuine flow state. Motion Creative Strategist bootcamp. Descript for AI-enhanced editing. 6+ years camera work. 60+ days of daily Reels content.", tools: ["DaVinci Resolve", "Descript", "CapCut"] },
      { name: "automation",    label: "AI Automation & Tooling",              proof: "AI Automation Specialist at Wayfair externship. Built 5–6 live n8n/Make pipelines. 11 AI certs. 35+ AI apps built. Daily Claude Code user. Not a tourist — these are working tools in live client work.", tools: ["n8n", "Make", "Lindy", "Claude Code", "Relevance.ai"] },
      { name: "design",        label: "Graphic Design & Visual Communication", proof: "Google UX Design cert + Uxcel UI/UX + Microsoft UX Design. Figma, Photoshop, Canva Pro. Marketing collateral, pitch decks, social graphics, brand guidelines execution for clients.", tools: ["Figma", "Photoshop", "Canva Pro"] },
      { name: "seo-content",   label: "SEO & Content Strategy",               proof: "Surfer SEO cert. HubSpot Inbound cert. ContentOS. AI-enabled content pipeline design. Content calendar management. Organic growth strategy as complement to paid acquisition.", tools: ["Surfer SEO", "HubSpot"] },
      { name: "email",         label: "Email Marketing & Sequences",          proof: "30%+ email opt-in rates. 6–8 email educational onboarding sequence at Prescene.ai via ConvertKit. PGA Premium Ghostwriting. LinkedInOS. Creator MBA. Email course architecture experience.", tools: ["ConvertKit", "Beehiiv"] },
      { name: "social",        label: "Social Content Creation",              proof: "60+ days of daily Reels. DJI Osmo Pocket. TikTok brand assets (3 campaign-ready). Social content packages via Bino Productions ($350–1,350/session). UGC-capable for brand campaigns.", tools: ["CapCut", "DJI Osmo"] },
      { name: "data",          label: "Data Analysis & Visualization",        proof: "UT Austin MSBA + Accenture executive Power BI dashboards for $200M+ data platform. CNN model at Favor (92% accuracy, 70% ROI). Capable and credentialed. Not a passion lane — honest about that.", tools: ["Power BI", "SQL", "Python", "Amplitude"] },
      { name: "photo",         label: "Photography",                          proof: "6 years. NatGeo-featured. Wedding/event photography via Bino Productions ($450–7,650/gig). Strong compositional eye for light, subject, and story. Visual storytelling foundation for everything else.", tools: [] },
      { name: "dots",          label: "Pattern Recognition & Connecting Dots", proof: "CliftonStrengths #1: Connectedness. I see patterns others miss because I read across fields — AI, education, design, strategy, philosophy — simultaneously. 93rd percentile Theory Development.", tools: [] },
    ]
  },
  {
    cat: "Tool Stack",
    color: "slate",
    icon: "⚙",
    desc: "Tools I actively use — not tools I've heard of. Each one has real reps, real deliverables, real outcomes.",
    skills: [
      { name: "automation-tools", label: "Automation & Workflow Builders",  proof: "Production-level experience: built live workflows at Wayfair that shipped to real use cases. Daily use for content and research pipelines.", tools: ["n8n", "Make", "Lindy", "Zapier"] },
      { name: "ai-tools",         label: "AI Agents & LLM Platforms",        proof: "Claude Code daily. 11 AI certs. 35+ AI apps built. Relevance.ai for agent chains. Not a tourist — these are working tools in live client and externship work.", tools: ["Claude Code", "Gemini", "Relevance.ai", "ChatGPT", "Cowork"] },
      { name: "video-tools",      label: "Video & Content Production Suite", proof: "DaVinci Resolve for editing (color, cut, audio). Descript for AI-enhanced workflows. Motion Creative Strategist bootcamp. Real hours in the chair.", tools: ["DaVinci Resolve", "Descript", "CapCut", "Final Cut Pro"] },
      { name: "design-tools",     label: "Design & Visual Stack",            proof: "Figma for systems mapping and decks. Photoshop for brand assets. Canva Pro for production speed. UX/UI certified. Client-facing marketing collateral delivered.", tools: ["Figma", "Photoshop", "Canva Pro", "Adobe Express"] },
      { name: "data-tools",       label: "Data & Analytics Stack",           proof: "UT Austin MSBA coursework + Accenture client-facing delivery for $200M+ projects. Amplitude cert. Tableau. Capable and credentialed.", tools: ["Power BI", "SQL", "Python", "Amplitude", "Tableau"] },
      { name: "ops-tools",        label: "Knowledge & Content Ops",          proof: "Notion Advanced Badge — OS manages life, content, and job search. ConvertKit for email sequences. HubSpot Inbound cert. Surfer SEO cert for content optimization.", tools: ["Notion", "ConvertKit", "HubSpot", "Surfer SEO"] },
    ]
  },
  {
    cat: "Honest Gaps",
...
const PROFILE = {
  ...
  experience: [
    ...
    { company: "Wedify.ai", role: "Fractional Creative Strategist", note: "Brand positioning brief, competitive analysis, and content strategy for live client. First active retainer — current engagement." },
    { company: "Entropy Studios", role: "Owner / Creative Director", note: "Photography, videography, content creation, and creative services. NatGeo-featured photography. Client shoots, event coverage, social content, and text/copy services." },
  ],
  education: [
